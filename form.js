class Form
{
    constructor()
     ...
     this.restart = createA('https://shubh-darwade.github.io/My-Rocket_game/','Restart');
      this.restart.hide();
     this.button3.hide();
     ...
     display()
     {
           ...
           this.restart.position(displayWidth/2,displayHeight/2);
        this.restart.style('fontSize','40px');
        this.restart.style('text','blue')
        this.restart.style('width', '200px');
        this.restart.style('height', '60px');
        this.restart.style('background', 'orange');
